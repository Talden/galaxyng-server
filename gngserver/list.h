...
typedef int ListCmp(List *elt, void *match);
typedef int ListForeach(List *item, void *userdata);

extern List *list_new(void *userdata);
extern List *list_remove(List **phead, void *match, ListCmp *cmp);
extern List *list_cons(List *head, List *tail);
extern List *list_tail(List *head);
extern List *list_nth(List *head, size_t n);
extern size_t list_length(List *head);
extern int list_foreach(List *head, ListForeach *foreach, void *userdata);
